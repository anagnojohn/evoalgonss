...
int main()
{
	...
	//! Pricing solvers
	Differential_Evo<double> de_pricing{ 0.6, 1, decision_variables, stdev, 60, 0.01, 400 };
	Differential_Evo<double> de_fitting{ 0.6, 1, decision_variables, stdev, 60, 0.0001, 400 };
	Genetic_Algo<double> ga_pricing{ 0.4, 0.35, 6.0, decision_variables, stdev_ga, 800, 0.00001, 400 };
